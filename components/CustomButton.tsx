...
const CustomButton=({onPress,title,bgVariant="primary",textVariant="default",IconLeft,IconRight,className,...props}:ButtonProps)=>{
    return <TouchableOpacity onPress={onPress} className={`w-full rounded-full flex p-3 mb-2 flex-row justify-center items-center shadow-md shadow-neutral-400/70 ${getBgVariantStyle(bgVariant)} ${className}}`} {...props}>
        {IconLeft && <IconLeft/>}
